...
export class EditUserComponent {
  ...
  ngOnInit() {
    ...
    // console.log("product edit",this.productDetail)
  ...
  onSaveProject() {
    ...
    if (this.projectForm.valid) {
      ...
      formData.append('phone', this.projectForm.value.phone);
      formData.append('country_code', this.projectForm.value.countryCode);
      formData.append('email', this.projectForm.value.email);
      formData.append('role', this.projectForm.value.role);
      formData.append('note', this.projectForm.value.note);

      console.log(formData);
      this.formVailde = true;
      this.userService
        .updateUser(this.userDetail.employee_id, formData)
        .subscribe(
          (res: any) => {
            console.log(res);
